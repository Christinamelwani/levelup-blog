    ...
    <Modal title="Register">
        <div class="modal_content" @submit.prevent="register">
            <form class="modal_form">
                <Input v-model="userData.name" name="name" label="Name" type="text" placeholder="Example Smith"
                    :required="false" />
                <Input v-model="userData.slug" name="slug" label="Nickname" type="text" placeholder="Exys"
                    :required="false" />
                <Input v-model="userData.email" name="email" label="Email" type="email" placeholder="example@mail.com"
                    :required="false" />
                <Input v-model="userData.password" name="password" label="Password" type="password"
